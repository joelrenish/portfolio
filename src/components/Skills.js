  ...
  return (
    <section id="skills" className="py-20 bg-secondary">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl font-bold mb-4 text-accent">My Tools</h2>
        <ul className="flex flex-wrap gap-4">
          {skills.map((skill, index) => (
            <li
              key={skill}
              className="px-4 py-2 bg-primary rounded opacity-0 text-accent" // Add opacity-0 to start hidden
